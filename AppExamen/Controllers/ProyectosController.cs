...
namespace AppExamen.Controllers
{
    public class ProyectosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Proyecto,NombreProyecto,FechaInicio,FechaFin")] Proyectos proyectos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Proyecto,NombreProyecto,FechaInicio,FechaFin")] Proyectos proyectos)
        {
            if (ModelState.IsValid)
            {
